...
var observer_observable_1 = require("../interfaces/observer-observable");
var Collection = /** @class */ (function (_super) {
    ...
    Collection.prototype.notify = function (event, model) {
        switch (event) {
            case observer_observable_1.MODEL_DELETED:
    ...
    Object.defineProperty(Collection.prototype, "dirtyModels", {
        get: function () {
            return utils_1.Utils.filter(this.models, { dirty: true });
        },
        enumerable: true,
        configurable: true
    });
     ...
     *
     */
    Collection.prototype.defaultRoutes = function () {
        return {
            fetch: "/" + this.name(),
        };
    };
    ...
    Collection.prototype.add = function (models) {
        ...
        models.forEach(function (model) {
            ...
            model.addObserver(_this);
        });
    };
    /**
     *
     */
    Collection.prototype.implace = function (models) {
        var _this = this;
        this.add(models.map(function (model) {
            var TModel = _this.model();
     ...
     *
     */
    Collection.prototype.findIndex = function (values) {
        return utils_1.Utils.findIndex(this.models, { values: values });
    };
    /**
     *
     */
    Collection.prototype.find = function (values) {
        return utils_1.Utils.find(this.models, { values: values });
    };
    /**
     *
     */
    Collection.prototype.remove = function (values) {
        // #TODO check if the model still is in the collection to avoid deadlocks.
        return utils_1.Utils.remove(this.models, { values: values });
    };
    /**
     *
     */
    Collection.prototype.filter = function (values) {
        return utils_1.Utils.filter(this.models, { values: values });
    };
    /**
     *
     */
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var success = function (response) {
                            _this.clear();
                            _this.implace(response.data);
                            resolve(response);
                        };
                        _this.request('fetch', params).then(success).catch(reject);
                    })];
            });
        });
    };
    return Collection;
}(requestable_1.Requestable));
exports.Collection = Collection;
;

},{"../interfaces/observer-observable":6,"./requestable":4,"./utils":5}],2:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var Model = /** @class */ (function (_super) {
     ...
     */
    function Model(values, collections) {
     ...
     */
    Model.prototype.observedBy = function (observer) {
        return utils_1.Utils.inArray(this._observers, observer);
    };
    /**
    ...
    Model.prototype.removeObserver = function (observer) {
        ...
        var removed = false;
        if (this.observedBy(observer)) {
            utils_1.Utils.remove(this._observers, observer);
            if (observer instanceof collection_1.Collection)
                observer.remove(this.values);
            removed = true;
        }
        return removed;
    };
    ...
    Model.prototype.fire = function (event) {
        var _this = this;
        this._observers.forEach(function (observer) { return observer.notify(event, _this); });
    };
    /**
    ...
    Object.defineProperty(Model.prototype, "values", {
        ...
        set: function (values) {
            this._values = __assign({}, this.defaults(), this.values, values);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Model.prototype, "syncValues", {
        /**
    ...
    Object.defineProperty(Model.prototype, "dirtyValues", {
        /**
         * The values that have changed since the last call of the sync method.
         */
        get: function () {
            return utils_1.Utils.objectDiff(this.values, this.syncValues);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Model.prototype, "dirty", {
         ...
         */
        get: function () {
            return !utils_1.Utils.isEqual(this.dirtyValues, {});
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Model.prototype, "deleted", {
        /**
     ...
     *
     */
    Model.prototype.defaultRoutes = function () {
        return {
            save: "/" + this.name(),
     ...
     */
    Model.prototype.patchUpdates = function () {
        return false;
    };
    /**
    ...
    Model.prototype.rollback = function () {
        ...
        this.fire(observer_observable_1.MODEL_ROLLBACK);
    };
    /**
     * Sets the sync object to the current model's values object. The previous sync status is lost.
     */
    Model.prototype.sync = function () {
        this._syncValues = __assign({}, this.defaults(), this.syncValues, this.values);
        this.fire(observer_observable_1.MODEL_SYNC);
    };
    /**
     ...
     */
    Model.prototype.addTo = function (collections) {
        var _this = this;
        collections.forEach(function (collection) { return collection.add([_this]); });
    };
    /**
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var success = function (response) {
                            ...
                            _this.sync();
                            _this.fire(observer_observable_1.MODEL_FETCHED);
                            resolve(response);
                        };
                        _this.request('fetch').then(success).catch(reject);
                    })];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var success = function (response) {
                            ...
                            _this.deleted = false;
                            _this.sync();
                            _this.fire(observer_observable_1.MODEL_SAVED);
                            resolve(response);
                        };
                        var action = _this.values.id ? (_this.patchUpdates() ? 'patch' : 'update') : 'save';
                        var data = action == 'patch' ? _this.dirtyValues : _this.values;
                        _this.request(action, data).then(success).catch(reject);
                    })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var success = function (response) {
                            _this.deleted = true;
                            _this.fire(observer_observable_1.MODEL_DELETED);
                            resolve(response);
                        };
                        _this.request('delete').then(success).catch(reject);
                    })];
            });
        });
    };
...
},{"../interfaces/observer-observable":6,"./collection":1,"./requestable":4,"./utils":5}],3:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
Object.defineProperty(exports, "__esModule", { value: true });
var collection_1 = require("./collection");
var PaginatedCollection = /** @class */ (function (_super) {
    __extends(PaginatedCollection, _super);
    function PaginatedCollection(models, page) {
        if (models === void 0) { models = []; }
    ...
    Object.defineProperty(PaginatedCollection.prototype, "currentPage", {
        get: function () {
    ...
    PaginatedCollection.prototype.pageParameter = function () {
        return 'page';
    };
    PaginatedCollection.prototype.paginationData = function (response) { };
    /**
     *
     */
    PaginatedCollection.prototype.fetch = function (params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        config[_this.pageParameter()] = _this.currentPage;
                        var success = function (response) {
                            _this.paginationData(response);
                            resolve(response);
                        };
                        _super.prototype.fetch.call(_this, config).then(success).catch(reject);
                    })];
            });
        });
    };
    ...
    PaginatedCollection.prototype.nextPage = function (params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.currentPage++;
                return [2 /*return*/, this.fetch(params)];
            });
        });
    };
    /**
    ...
    PaginatedCollection.prototype.goToPage = function (number, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
...
var Requestable = /** @class */ (function () {
     ...
     */
    Requestable.prototype.basePath = function () {
        return '';
    };
    /**
     *
     */
    Requestable.prototype.name = function () {
        return utils_1.Utils.classNameToApiRoute(this.constructor.name);
    };
    /**
     * The error code number returned when the validation of a request's parameters fails.
     */
    Requestable.prototype.validationErrorCode = function () {
        return 422;
    };
    /**
     *
     */
    Requestable.prototype.defaultMethods = function () {
        return {
            save: 'POST',
            fetch: 'GET',
            patch: 'PATCH',
     ...
     *
     */
    Requestable.prototype.methods = function () {
        return {};
    };
    /**
     *
     */
    Requestable.prototype.defaultRoutes = function () {
        return {};
    };
    /**
     * The routes for this model. If not is overridden, then returns the defaults.
     */
    Requestable.prototype.routes = function () {
        return {};
    };
    Object.defineProperty(Requestable.prototype, "loading", {
        get: function () {
     ...
     *
     */
    Requestable.prototype.request = function (action, data) {
        var _this = this;
        if (data === void 0) { data = {}; }
        var routes = __assign({}, this.defaultRoutes(), this.routes());
        var methods = __assign({}, this.defaultMethods(), this.methods());
        if (!routes.hasOwnProperty(action))
            throw "The route for the " + action + " action does not exists.";
        if (!methods.hasOwnProperty(action))
            throw "The method for the " + action + " action does not exists.";
        ...
        var config = __assign({ method: method, url: this.basePath() + routes[action] }, extraConfig);
        return new Promise(function (resolve, reject) {
            var clear = function () { return _this.loading = false; };
            var success = function (response) {
                clear();
                resolve(response);
            };
            ...
            _this.loading = true;
            axios_1.default(config).then(success).catch(error);
        });
    };
    return Requestable;
}());
...
},{"./utils":5,"axios":8}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Utils = /** @class */ (function () {
     ...
     *
     */
    Utils.objectDiff = function (object, base) {
     ...
     *
     */
    Utils.findIndex = function (array, search) {
        return _.findIndex(array, search);
    };
    /**
     *
     */
    Utils.find = function (array, search) {
        return _.find(array, search);
    };
    /**
     *
     */
    Utils.remove = function (array, search) {
     ...
     *
     */
    Utils.filter = function (array, search) {
        return _.filter(array, search);
    };
    /**
     *
     */
    Utils.pluralize = function (word) {
        return pluralize(word);
    };
    /**
     *
     */
    Utils.classNameToApiRoute = function (className) {
        return pluralize(className.replace(/([a-zA-Z])(?=[A-Z])/g, '$1-')).toLowerCase();
    };
    /**
     *
     */
    Utils.inArray = function (array, what) {
...
},{"lodash":34,"pluralize":35}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
 * Library events are all negatives, this way the users can define their own events with positive numbers.
 */
exports.MODEL_SYNC = -0;
exports.MODEL_SAVED = -1;
exports.MODEL_FETCHED = -2;
exports.MODEL_DELETED = -3;
exports.MODEL_ROLLBACK = -4;
...
var paginated_collection_1 = require("./classes/paginated-collection");
exports.PaginatedCollection = paginated_collection_1.PaginatedCollection;
window.Model = model_1.Model;
window.Collection = collection_1.Collection;
window.PaginatedCollection = paginated_collection_1.PaginatedCollection;

},{"./classes/collection":1,"./classes/model":2,"./classes/paginated-collection":3}],8:[function(require,module,exports){
